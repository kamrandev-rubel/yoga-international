...
const About = () => {
    return (
        <div style={{ backgroundImage: `url('')` }} className='w-[100%] bg-[length:100%_340px] h-[340px] lg:bg-[length:100%_675px] lg:h-[675px] md:bg-[length:100%_430px] md:h-[430px] bg-no-repeat'>
